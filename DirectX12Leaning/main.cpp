...
int WINAPI WinMain(_In_ HINSTANCE hinstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd) 
{
	...
	//DrawObject
	Draw3D enemyObject(DrawShapeData::Box, 2, D3D12_FILL_MODE_SOLID, dev, cmdList, window_width, window_height);
	DirectX::XMFLOAT4 enemyColor = dx12.GetColor(255, 255, 255, 255);
	Position3D enemyPos = {-20, 0, 0};

	Draw2DGraph BG0(L"Resources/data.png", D3D12_FILL_MODE_SOLID, dev, cmdList, 1920, 1080);
	Draw2DGraph BG1(L"Resources/data.png", D3D12_FILL_MODE_SOLID, dev, cmdList, 1920, 1080);
	float xAdjust[2] = {0, 2};
